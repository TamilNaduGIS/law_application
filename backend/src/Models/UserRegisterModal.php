...
class UserRegisterModal
{
     ...
     */
    public static function createAccount(array $payload): array
    {
        ...
        try {
            $result = self::callProcedure($json);
     ...
     */
    private static function callProcedure(string $json): ?array
    {
        ...
        return self::parseProcedureOutput($rows);
    }
     ...
     */
    public static function loginApplicant(string $mobile, string $enrollmentNo): array
    {
        $payload = json_encode([
            'mobile_no' => $mobile,
        ...
        try {
            $result = self::callLoginProcedure($payload);
     ...
     * @return array<string, mixed>|null
     */
    private static function callLoginProcedure(string $json): ?array
    {
        $escaped = str_replace("'", "''", $json);
        $stmt = Database::WriteConnection()->query(
