...
(function (AF, global) {
    ...
    function formatCalculatedYears(years) {
        ...
        const capped = Math.min(Math.max(years, 0), 99);
    ...
    const MSG = {
        ...
        minExperience: 'Experience must be greater than 0.',
    ...
    function restoreTab3FromState() {
        ...
        if (barItems.length > 0) {
            ...
            barItems.forEach(function (item, index) {
                ...
                if (item.years) {
                    $item.find('.bar-years').val(item.years);
                }
        ...
        if (practiceItems.length > 0) {
            ...
            practiceItems.forEach(function (item, index) {
                ...
                updateItemExperienceYears($item);
                if (item.years) {
                    $item.find('.practice-years').val(item.years);
                }
